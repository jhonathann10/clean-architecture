...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrder, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrder, error) {
	out := new(ListOrder)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*ListOrder, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*ListOrder, error) {
